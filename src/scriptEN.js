...
function createProductElement(product) {
  ...
  productElement.innerHTML = `
        <div class="item flex justify-center relative border rounded-xl overflow-hidden cursor-pointer group new-item"
...
function langageSite() {
  // Sélection des éléments à afficher/cacher
  const dropdownMenu = document.querySelector('.listLang');
  const triangle = document.querySelector('.triangle');

  // Inverser la visibilité de la liste déroulante et du triangle
