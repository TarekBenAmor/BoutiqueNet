...
<body class="bg-gray-800 text-white" dir="rtl" style="font-family: 'Rubik';">
  ...
  <nav class="bg-gray-900 p-4 mb-6">
    <div class="container flex flex-col max-w-6xl mx-auto gap-8 items-center sm:flex-row">
      ...
      <div class="relative w-full">
        <input type="text" id="search" placeholder="ابحث عن منتج..." class="bg-gray-700 rounded-full p-2 pr-10 focus:w-full">
        <svg class="absolute right-2 top-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" fill="none">
    ...
    <div class="py-4">
      <div class="container mx-auto max-w-7xl flex flex-col md:flex-row items-center my-12 md:my-24">
        <div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
          <h1 class="text-3xl md:text-5xl p-2 text-yellow-300 tracking-loose">ابحث عن منتجك المفضل</h1>
          </h2>
          <p class="text-sm md:text-base text-gray-50 mb-4">ما عليك إلا أن تختار الفئة التي تريد التسوق منها</p>
