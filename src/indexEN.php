...
<body class="bg-gray-800 text-white" dir="ltr" style="font-family: 'Rubik';">
  ...
  <nav class="bg-gray-900 p-4 mb-6">
    <div class="container flex flex-col max-w-6xl mx-auto gap-8 items-center sm:flex-row">
      ...
      <div class="relative w-full">
        <input type="text" id="search" placeholder="Search for a product..." class="bg-gray-700 rounded-full p-2 pl-10 focus:w-full">
    ...
    <div class="py-4">
      <div class="container mx-auto max-w-7xl flex flex-col md:flex-row items-center my-12 md:my-24">
        <div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
          <h1 class="text-3xl md:text-5xl p-2 text-yellow-300 tracking-loose">Search for your favorite product</h1>
          </h2>
          <p class="text-sm md:text-base text-gray-50 mb-4">You just need to choose the category you want to shop from</p>
  ...
  <!-- Filtre de produits par categorie -->
  <main class="container flex flex-col max-w-6xl mx-auto sm:flex-row">
    <div class="space-y-4 mb-2 p-4 w-full sm:max-w-[10rem]">
      ...
      <div id="filter-container" class="space-y-2">
        ...
        <div>
          <input type="checkbox" class="check" id="pc" />
          <label for="pc">PC portable</label>
        </div>
      </div>
    </div>
